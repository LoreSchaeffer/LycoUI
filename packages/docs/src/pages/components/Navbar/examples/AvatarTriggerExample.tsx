...
export const description = <p>Use the <code>unstyled</code> prop on <code>Navbar.Dropdown</code> to replace the default trigger with a fully custom layout. This example shows a user profile trigger with an avatar, name, and a caret icon — a common pattern in application navbars.</p>;
