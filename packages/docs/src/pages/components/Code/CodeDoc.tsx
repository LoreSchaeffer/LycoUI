            ...
            description={
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    ...
                    <div style={{ padding: '1rem', backgroundColor: 'var(--color-obsidian)', borderRadius: 'var(--radius-md)', border: '1px solid var(--color-border-subtle)' }}>
                        ...
                        <p style={{ margin: '0.5rem 0' }}>To use syntax highlighting, you must manually install <code>shiki</code>. It is an optional dependency to keep our core library small. If missing, it safely falls back to standard text.</p>
