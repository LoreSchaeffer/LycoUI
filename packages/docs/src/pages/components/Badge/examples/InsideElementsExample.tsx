  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
        ...
        <Button variant="neutral" className="btn-outlined">
          Messages
      ...
      <div>
        <h1>Heading H1 <Badge variant="neutral">New</Badge></h1>
        <h2>Heading H2 <Badge variant="primary">New</Badge></h2>
        <h3>Heading H3 <Badge variant="success">New</Badge></h3>
        <h4>Heading H4 <Badge variant="warning">New</Badge></h4>
        <h5>Heading H5 <Badge variant="danger">New</Badge></h5>
        <h6>Heading H6 <Badge variant="info">New</Badge></h6>
      </div>
    </div>
  );
}
