...
export const description = <p>Validation can be automatic (based on native HTML constraints and a custom <code>validationFn</code>), or manually controlled via the <code>validation</code> prop. Auto-validation triggers after the first blur.
</p>;
