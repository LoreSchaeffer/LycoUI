import {Col, Row, Sidebar} from '@loreschaeffer/lyco-ui';
import React from 'react';

export const title = 'Basic Navigation';
export const description = <p>A standard static sidebar using the provided navigation components. Icons are explicitly passed.</p>;
export const order = 1;

export const vanillaHtml = `
<aside class="sidebar sidebar--fixed" style="position: relative; height: 400px;">
