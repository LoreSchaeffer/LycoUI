...
export const description = <p>Avatars can display images, text initials, or icons. If an image fails to load, it will automatically show the provided fallback without any visual jank.</p>;
...
export default function BasicExample() {
    ...
    return (
        <Row>
            <Col span={12}>
                <div className="d-flex" style={{gap: '2rem', flexWrap: 'wrap', alignItems: 'center'}}>
