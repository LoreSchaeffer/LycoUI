import {Code, NotificationProvider} from '@loreschaeffer/lyco-ui';
                    ...
                    <div style={{display: 'flex', flexDirection: 'column', gap: '1.5rem'}}>
                        ...
                        <div style={{padding: '1rem', backgroundColor: 'var(--color-surface-elevated)', borderRadius: 'var(--radius-md)', border: '1px solid var(--color-border-subtle)'}}>
                            ...
                            <p style={{margin: '0.5rem 0 1rem 0', color: 'var(--color-text-secondary)'}}>
                                To use notifications in your React application, you <strong>must</strong> wrap your app (or a relevant subtree) in a <code>&lt;NotificationProvider&gt;</code>. Then, use
                                the <code>useNotification()</code> hook to trigger toasts from any component.
                            </p>
  ...
  return (
    <NotificationProvider position="bottom-right">
      <YourApp />
                ...
                a11yNotes={`Uses \`role="alert"\` or \`role="status"\` depending on severity. Automatically announces to screen readers.`}
